...
return [
    ...
    // 默认全局过滤方法 用逗号分隔多个
    'default_filter'         => 'trim,strip_tags,htmlspecialchars,stripslashes',
    // 默认语言
    'default_lang'           => 'zh-cn',
    // 应用类库后缀
    'class_suffix'           => false,
    ...
    'allow_method'=>[
        ...
        'api/drug.netdrug/index',
        'chat/index/chatimgupload',
        'chat/index/savemessage',
        'chat/index/changeisread',
        'chat/index/checknoneuser',
        'chat/index/checkadminid',
        'chat/index/loadmessagelist',
